...
int stack::pop()
{
   ...
   else if(capacity>1 && top+1==(capacity/2))
   {
      halfArray();
      return 2;
   }
...
int menu()
{
    ...
    cout<<endl<<"\t  STACK DATA STRUCTURE USING DYNAMIC ARRAY\t";
    ...
    while(1)
    {
        switch(menu())
        {
            ...
            case 2:
            {
                ...
                if(k==2)
                cout<<endl<<"PUSH SUCCESSFULL USING DYNAMIC ARRAY"<<endl;
                break;
            }
            case 3:
            {
                ...
                if(k==2)
                cout<<endl<<"POP SUCCESSFULL USING DYNAMIC ARRAY"<<endl;
                break;
            }
            case 4:
            {
