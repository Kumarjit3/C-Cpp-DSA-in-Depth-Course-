...
{
    int k;
    cout<<endl<<"\n\tDEQUE DATA STRUCTURE USING DYNAMIC ARRAY"<<endl;
        ...
        switch(menu())
        {
           ...
           case 4:
           {
               ...
               else
               {
                  ...
                  if(k==2)
                  cout<<endl<<"Front Insert IS Successful Using Dynamic Array"<<endl;
               }
               break;
           }
           case 5:
           {
               ...
               else
               {
                  ...
                  if(k==2)
                  cout<<endl<<"Rear Insert IS Successful Using Dynamic Array"<<endl;
               }
               break;
           }
           case 6:
           ...
           case 8:
           {
               if(d1.ptrEmpty())
                ...
                else
                {
                     ...
                     if(k==2)
                     cout<<endl<<"Front Delete Is Successful Using Dynamic Array"<<endl;
                }
                 break;
           }
           case 9:
           {
                ...
                else
                {
                     ...
                     if(k==2)
                     cout<<endl<<"Rear Delete Is Successful Using Dynamic Array"<<endl;
                }
                 break;
           }
           case 10:
